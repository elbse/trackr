...
import { registerUser } from '../api/applications'
    ...
    <div style={styles.wrapper}>
      <div style={styles.shell}>
        <div style={styles.titlebar}>
          ...
          <span style={styles.label}>trackr — register</span>
        </div>

        <div style={styles.body}>
          <div style={styles.prompt}>
            <span style={styles.green}>›</span> create your account
          </div>
